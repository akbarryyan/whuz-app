  ...
  return (
    <footer className="-mt-14 bg-white shadow-2xl overflow-hidden pb-24">
      ...
      <div className="px-5 py-4">
        ...
        <p className="text-[12px] text-[#6A7389] mb-1">PT Whuzpay Digital Indonesia</p>

        <div className="flex flex-col gap-1">
          {/* WhatsApp */}
          <a href="https://wa.me/6281234567890" className="inline-flex items-center gap-2 text-[13px] text-purple-600 hover:text-purple-700 transition-colors">
          ...
          {/* Email */}
          <a href="mailto:support@whuzpay.com" className="inline-flex items-center gap-2 text-[13px] text-purple-600 hover:text-purple-700 transition-colors">
      ...
      <div className="px-5 mt-4">
        ...
        <div className="flex flex-col gap-1">
          {["Berita Game", "Menjadi Penjual", "Menjadi Mitra (Reseller)", "Karir"].map(
            (link) => (
              <a key={link} href="#" className="text-[12px] font-semibold text-[#6A7389] hover:text-purple-700 transition-colors">
                {link}
              </a>
            )
          )}
