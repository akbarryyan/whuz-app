...
export default function BannerCarousel() {
  ...
  return (
    <div className="relative bg-white -mt-0 mb-0">
      ...
      <button
        onClick={prevBanner}
        className="absolute left-2 top-1/3 -translate-y-1/3 bg-white/80 hover:bg-white rounded-full p-2 shadow-lg transition-all z-10"
      >
      ...
      <button
        onClick={nextBanner}
        className="absolute right-2 top-1/3 -translate-y-1/3 bg-white/80 hover:bg-white rounded-full p-2 shadow-lg transition-all z-10"
      >
        <svg className="w-5 h-5 text-slate-800" fill="none" stroke="currentColor" viewBox="0 0 24 24">
